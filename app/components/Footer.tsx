      ...
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-12 lg:col-span-4 mb-8 lg:mb-0 flex flex-col items-start">
            ...
            {/* NEW: CSS Text Gradient Logo */}
            <Link href="/" className="mb-8 block group">
              <div className="flex items-center">
                {/* Gradient 'meridian' */}
                <span className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent group-hover:opacity-80 transition-opacity">
                  meridian
                </span>
                {/* Subtle Divider */}
                <span className="text-3xl font-light text-slate-600 mx-3 pb-1">|</span>
            ...
            {/* Social Icons - Perfectly aligned underneath */}
